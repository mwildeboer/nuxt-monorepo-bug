...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../node_modules/nuxt/dist/app/plugins/cross-origin-prefetch.client").default> &
...
declare module '#app' {
  ...
  interface NuxtAppLiterals {
    pluginName: 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:router' | 'nuxt:revive-payload:server' | 'nuxt:global-components' | 'nuxt:prefetch' | 'nuxt:chunk-reload' | 'nuxt:cross-origin-prefetch' | 'nuxt:checkIfLayoutUsed'
  }
}
