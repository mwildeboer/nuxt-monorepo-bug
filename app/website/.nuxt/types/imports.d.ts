...
declare global {
  ...
  const usePageData: typeof import('../../composables/use-page-data/use-page-data')['usePageData']
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly usePageData: UnwrapRef<typeof import('../../composables/use-page-data/use-page-data')['usePageData']>
